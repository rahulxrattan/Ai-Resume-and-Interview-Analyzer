...
//   const { location, jobType, experience, category } = await req.json();

//   // More flexible query construction
//   const query = [category, jobType, experience, location]
//     .filter(Boolean)
//     .join(' ');
...
//     // Simplified URL extraction (like your original working version)
