...
//                   <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="4" strokeDasharray="31.4, 31.4" />
//                 </svg>
//                 Searching...
//               </span>
//             ) : "Find Jobs"}
...
//                     {job.via && (
//                       <span className="text-gray-500">• via {job.via.replace(/^via /i, '')}</span>
//                     )}
//                   </div>
//                 </div>
...
//                   </a>
//                 ) : (
//                   <span className="mt-3 md:mt-0 inline-flex items-center justify-center px-5 py-2 bg-gray-100 text-gray-600 rounded-md text-sm whitespace-nowrap cursor-not-allowed">
//                     No Link Available
//                   </span>
//                 )}
//               </div>
...
//                 Try searching for "React developer", "Full stack engineer", etc.
//               </p>
//             </div>
//           )
//         )}
